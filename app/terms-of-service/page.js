          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p>
                  โปรดอ่านข้อกำหนดและเงื่อนไขการใช้บริการนี้อย่างละเอียดก่อนการใช้งานเว็บไซต์และบริการของสภาอุตสาหกรรมแห่งประเทศไทย
                  ("สภาอุตสาหกรรมฯ") การใช้บริการของท่านถือเป็นการยอมรับข้อกำหนดและเงื่อนไขเหล่านี้
                </p>

                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">1. การใช้บริการ</h3>
                  <p className="mb-4">
                    ท่านตกลงที่จะใช้บริการของสภาอุตสาหกรรมฯ ตามวัตถุประสงค์ที่ชอบด้วยกฎหมายเท่านั้น
                    และจะไม่ใช้บริการในลักษณะดังต่อไปนี้:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>ละเมิดกฎหมาย ระเบียบ หรือข้อบังคับใดๆ</li>
                    <li>ละเมิดสิทธิของบุคคลอื่น รวมถึงสิทธิในทรัพย์สินทางปัญญา</li>
                    <li>
                      ส่งหรือเผยแพร่เนื้อหาที่ไม่เหมาะสม ผิดกฎหมาย หรือละเมิดสิทธิของบุคคลอื่น
                    </li>
                ...
                <div>
                  ...
                  <p className="mb-4">ในการสมัครเป็นสมาชิกของสภาอุตสาหกรรมฯ ท่านจะต้อง:</p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>ให้ข้อมูลที่ถูกต้อง เป็นปัจจุบัน และครบถ้วน</li>
                    <li>รักษาความลับของรหัสผ่านและบัญชีของท่าน</li>
                    <li>
                      แจ้งให้สภาอุตสาหกรรมฯ ทราบทันทีหากมีการใช้บัญชีของท่านโดยไม่ได้รับอนุญาต
                    </li>
                ...
                <div>
                  ...
                  <p>
                    เนื้อหา ข้อมูล
                    และทรัพย์สินทางปัญญาทั้งหมดที่ปรากฏบนเว็บไซต์และบริการของสภาอุตสาหกรรมฯ
                    เป็นทรัพย์สินของสภาอุตสาหกรรมฯ หรือบุคคลที่สามที่ได้รับอนุญาต
                    ท่านไม่มีสิทธิที่จะทำซ้ำ ดัดแปลง เผยแพร่
                    หรือใช้ประโยชน์จากทรัพย์สินทางปัญญาดังกล่าวโดยไม่ได้รับอนุญาตเป็นลายลักษณ์อักษรจากสภาอุตสาหกรรมฯ
                ...
                <div>
                  ...
                  <p className="mb-4">
                    สภาอุตสาหกรรมฯ จะไม่รับผิดชอบต่อความเสียหายใดๆ
                    ที่เกิดขึ้นจากการใช้หรือไม่สามารถใช้บริการของสภาอุตสาหกรรมฯ
                ...
                <div>
                  ...
                  <p>
                    สภาอุตสาหกรรมฯ อาจเปลี่ยนแปลงข้อกำหนดและเงื่อนไขการใช้บริการนี้เป็นครั้งคราว
                    โดยจะแจ้งให้ท่านทราบผ่านทางเว็บไซต์หรือช่องทางอื่นที่เหมาะสม
                ...
                <div>
                  ...
                  <p className="mb-4">
                    หากท่านมีข้อสงสัยหรือข้อเสนอแนะเกี่ยวกับข้อกำหนดและเงื่อนไขการใช้บริการนี้
