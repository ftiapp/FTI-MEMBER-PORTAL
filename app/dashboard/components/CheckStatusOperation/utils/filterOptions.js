...
export const operationTypeOptions = [
  ...
  { value: 'แก้ไขข้อมูลสินค้า', label: 'แก้ไขข้อมูลสินค้า' },
  { value: 'อัปเดตโซเชียลมีเดีย', label: 'อัปเดตโซเชียลมีเดีย' },
  { value: 'อัปเดตโลโก้บริษัท', label: 'อัปเดตโลโก้บริษัท' },
  { value: 'อัปเดตรหัส TSIC', label: 'อัปเดตรหัส TSIC' },
