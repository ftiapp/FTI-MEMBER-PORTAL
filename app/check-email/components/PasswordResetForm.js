  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success(
          "ตั้งรหัสผ่านใหม่สำเร็จ คุณสามารถเข้าสู่ระบบด้วยอีเมลใหม่และรหัสผ่านใหม่ได้ทันที",
        );
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 mb-6 text-center">
        อีเมลใหม่ <span className="font-semibold">{newEmail}</span> ได้รับการยืนยันเรียบร้อยแล้ว
        <br />
