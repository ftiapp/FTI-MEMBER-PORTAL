      ...
      <div className="flex flex-col py-4 px-6 space-y-3">
        ...
        <div className="space-y-1">
          <div className="px-4 mb-1">
            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">เมนูหลัก</h3>
          </div>
          {menuItems.map((item) => (
            <div key={item.name}>
              <a
        ...
        {user ? (
          <>
            ...
            <div className="space-y-1 pt-3 border-t border-gray-200">
              <div className="px-4 mb-1">
                <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">บริการสมาชิก</h3>
              </div>
              <a
              ...
              <a
                ...
                className="flex items-center px-6 py-3 rounded-xl text-gray-700 hover:text-blue-700 hover:bg-blue-50 transition-colors"
              >
                <svg className="w-5 h-5 mr-3 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
