...
export default function ActionButton({ href, children, variant = "primary", external = false, className = "", onClick }) {
  const baseClasses = "px-4 py-2 rounded-md font-medium transition-all duration-200 relative overflow-hidden group text-sm inline-flex items-center justify-center gap-2 shadow-sm hover:shadow-md";
  const variants = {
