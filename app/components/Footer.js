    ...
    >
      <div className="container mx-auto px-4 max-w-7xl w-full">
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
          ...
          <motion.div className="mb-4 sm:mb-0" variants={itemVariants}>
            ...
            <motion.p className="text-gray-400 mb-3 text-xs sm:text-sm" variants={itemVariants}>
              ...
              องค์กรที่มุ่งมั่นพัฒนาและส่งเสริมอุตสาหกรรมไทยให้เติบโตอย่างยั่งยืน
            </motion.p>
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.ul
              className="space-y-3 text-xs sm:text-sm text-gray-300"
              variants={itemVariants}
            >
              <motion.li className="flex items-start" variants={itemVariants}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 sm:h-5 sm:w-5 mr-2 sm:mr-3 text-blue-400 flex-shrink-0 mt-1"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        >
          ...
          >
            <p>
              {new Date().getFullYear()} ฝ่ายดิจิทัลและเทคโนโลยี สภาอุตสาหกรรมแห่งประเทศไทย.
              สงวนลิขสิทธิ์.
            </p>
          ...
          <motion.div
            className="flex flex-wrap justify-center lg:justify-end gap-3 lg:gap-4 w-full lg:w-auto"
            variants={itemVariants}
          >
