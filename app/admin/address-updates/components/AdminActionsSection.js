      ...
      {selectedRequest.status === "pending" && (
        <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-emerald-50 to-teal-50">
          ...
          <div className="bg-white p-6 rounded-xl border border-emerald-200 shadow-sm">
            <div className="mb-6">
              <label htmlFor="adminNotes" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{formatDate(selectedRequest.processed_date)}</p>
                </div>
              </div>
              ...
              {selectedRequest.approved_by_admin_name && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{selectedRequest.approved_by_admin_name}</p>
                  </div>
                </div>
              )}
              ...
              {selectedRequest.admin_notes && (
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-semibold text-gray-900 bg-yellow-50 p-3 rounded-lg">{selectedRequest.admin_notes}</p>
                  </div>
                </div>
              )}
              ...
              {selectedRequest.admin_comment && (
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-semibold text-red-800 bg-red-50 p-3 rounded-lg">{selectedRequest.admin_comment}</p>
                  </div>
                </div>
              )}
            </div>
