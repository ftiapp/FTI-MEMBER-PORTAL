...
import { getMemberTypeName, getMemberSubtypeName, getAddressTypeName, getLanguageLabel, formatDate } from "./addressUtils";
    ...
    <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="font-semibold text-gray-900">{getMemberTypeName(selectedRequest.member_type)}</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="font-semibold text-gray-900">{getMemberSubtypeName(selectedRequest.type_code)}</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="font-semibold text-gray-900">{getAddressTypeName(selectedRequest.addr_code)}</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="font-semibold text-gray-900">{getLanguageLabel(selectedRequest.addr_lang)}</p>
        </div>
