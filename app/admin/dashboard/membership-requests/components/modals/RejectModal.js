        ...
        <div className="flex items-start gap-3 border-b border-gray-100 px-6 py-5">
          <div className="mt-0.5 inline-flex h-10 w-10 items-center justify-center rounded-full bg-red-50 text-red-600 ring-1 ring-red-100">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
              <path fillRule="evenodd" d="M9.401 1.737a2.25 2.25 0 0 1 3.198 0l9.664 9.664c.879.879.879 2.303 0 3.182l-9.664 9.664a2.25 2.25 0 0 1-3.198 0L.737 14.583a2.25 2.25 0 0 1 0-3.182l8.664-8.664ZM12 7.5a.75.75 0 0 0-.75.75v4.5a.75.75 0 1 0 1.5 0V8.25A.75.75 0 0 0 12 7.5Zm0 9a.875.875 0 1 0 0 1.75.875.875 0 0 0 0-1.75Z" clipRule="evenodd" />
            </svg>
          </div>
          <div className="min-w-0 flex-1">
            <h3 className="text-lg font-semibold text-gray-900">ยืนยันการปฏิเสธการสมัครสมาชิก</h3>
            <p className="mt-1 text-sm text-gray-600">ตรวจสอบข้อมูลให้ครบถ้วนก่อนดำเนินการ ระบบจะส่งอีเมลแจ้งผลไปยังผู้สมัคร</p>
          </div>
        </div>
        ...
        <div className="space-y-4 px-6 py-5">
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50/60 p-3 text-sm text-gray-700">
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
              <div className="truncate"><span className="text-gray-500">ชื่อบริษัท/ผู้ยื่น:</span> <span className="font-medium">{companyName || '-'}</span></div>
              <div className="truncate"><span className="text-gray-500">TAX ID/เลขบัตร:</span> <span className="font-medium">{taxId || '-'}</span></div>
            </div>
          </div>
          ...
          {/* Reason */}
          <div>
            <label htmlFor="reject-reason" className="block text-sm font-medium text-gray-700">เหตุผลในการปฏิเสธ</label>
            <textarea
              id="reject-reason"
