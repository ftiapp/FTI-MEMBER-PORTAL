        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            {application.industrialGroups.map((group, index) => {
              ...
              const id = group.industry_group_id || group.id || group.MEMBER_GROUP_CODE || group.code || group;
              return (
        ...
        <div>
          ...
          <div className="space-y-3">
            {application.provincialChapters.map((chapter, index) => {
              ...
              const id = chapter.province_chapter_id || chapter.id || chapter.MEMBER_GROUP_CODE || chapter.code || chapter;
              return (
                <div key={index} className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-lg font-medium text-gray-900">
                    {name || `รหัส: ${id}`}
