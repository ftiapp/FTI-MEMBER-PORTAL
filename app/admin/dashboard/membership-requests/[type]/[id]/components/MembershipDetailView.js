  ...
  return (
    <div className="min-h-screen bg-blue-50 p-6">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-blue-200 p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-900">
                  {application.phone || '-'}
                  {application.phoneExtension && (
                    <span className="text-blue-600 ml-2">ต่อ {application.phoneExtension}</span>
                  )}
                </p>
              </div>
            </div>
              ...
              <>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">
                    ...
                    {(application.company_phone_extension || application.companyPhoneExtension || application.associationPhoneExtension) && (
                      <span className="text-blue-600 ml-2">ต่อ {application.company_phone_extension || application.companyPhoneExtension || application.associationPhoneExtension}</span>
                    )}
                  </p>
                </div>
        ...
        {/* 3. กลุ่มอุตสาหกรรมและสภาอุตสาหกรรมจังหวัด */}
        ...
        {/* 3. ข้อมูลทางการเงิน */}
        {type !== 'ic' && (application.registered_capital || application.registeredCapital || 
                           application.production_capacity_value || application.productionCapacityValue ||
                           application.sales_domestic || application.salesDomestic ||
                           application.sales_export || application.salesExport ||
          ...
          <div className="bg-white rounded-xl shadow-sm border border-blue-200 p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {(application.registered_capital || application.registeredCapital) && (
                <div>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">
                    {(() => {
                      ...
                      return thaiPercent ? `${Number(thaiPercent).toFixed(2)}%` : '-';
                    })()}
                  </p>
                </div>
              )}
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">
                    {(() => {
                      ...
                      return foreignPercent ? `${Number(foreignPercent).toFixed(2)}%` : '-';
                    })()}
                  </p>
                </div>
              )}
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {rep.phone || '-'}
                            {rep.phoneExtension && (
                              <span className="text-blue-600 ml-2">ต่อ {rep.phoneExtension}</span>
                            )}
                          </p>
                        </div>
                        <div>
