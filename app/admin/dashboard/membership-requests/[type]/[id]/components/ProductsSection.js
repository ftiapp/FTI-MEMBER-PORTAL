          ...
          <div className="flex flex-wrap gap-2">
            {application.businessTypes.map((businessType, index) => {
              ...
              if (typeKey === "other") {
                ...
                let otherDetail = "";
                if (
                  Array.isArray(application.businessTypeOther) &&
                  ...
                  if (typeof businessType === "object" && businessType.main_id != null) {
                    ...
                    otherDetail =
                      (found && (found.detail || found.description || found.other_detail)) || "";
                  } else {
                    // fall back: if only one other detail provided
                    const first = application.businessTypeOther[0];
                    otherDetail =
                      (first && (first.detail || first.description || first.other_detail)) || "";
                  }
                }
                return (
                  <span
