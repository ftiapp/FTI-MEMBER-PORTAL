      ...
      <div>
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex space-x-2">
            <span className={`text-xs px-2 py-1 rounded-full ${STATUS_COLORS[selectedMessage.status]}`}>
              {STATUS_LABELS[selectedMessage.status]}
            </span>
            {selectedMessage.priority && (
              <span className={`text-xs px-2 py-1 rounded-full ${PRIORITY_COLORS[selectedMessage.priority]}`}>
