  ...
  if (!selectedRequest) {
    return (
      ...
      >
        ...
        <p className="text-sm text-gray-500 mt-2">คลิกที่รายการด้านซ้ายเพื่อดูข้อมูลเพิ่มเติม</p>
      </motion.div>
    );
  }
          ...
          <div className="pt-4 border-t-2 border-gray-200 bg-red-50 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-2">
                ...
                <p className="text-sm text-gray-700 font-semibold">
                  <span className="font-bold text-red-700">เหตุผล:</span>{" "}
