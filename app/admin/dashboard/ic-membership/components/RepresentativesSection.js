            ...
            <div key={index} className="border border-gray-200 rounded-md p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {editMode ? (
                  ...
                  <>
                    <div>
                      <span className="block text-sm font-medium text-gray-700">ชื่อ-นามสกุล (ไทย)</span>
                      <span>{representative.first_name_thai} {representative.last_name_thai}</span>
                    </div>
                    
                    <div>
                      <span className="block text-sm font-medium text-gray-700">ชื่อ-นามสกุล (อังกฤษ)</span>
                      <span>{representative.first_name_english} {representative.last_name_english}</span>
                    </div>
                    ...
                    <div>
                      <span className="block text-sm font-medium text-gray-700">ตำแหน่ง (อังกฤษ)</span>
