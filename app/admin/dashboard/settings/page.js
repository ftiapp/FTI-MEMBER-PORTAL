...
export default function SettingsPage() {
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      ...
      case "system":
        return (
          <SystemSettings settings={settings} onSave={handleSaveSettings} isLoading={saving} />
        );
      case "api":
        return <ApiSettings settings={settings} onSave={handleSaveSettings} isLoading={saving} />;
      case "backup":
        return (
          <BackupSettings settings={settings} onSave={handleSaveSettings} isLoading={saving} />
        );
      default:
        return (
          <SecuritySettings settings={settings} onSave={handleSaveSettings} isLoading={saving} />
