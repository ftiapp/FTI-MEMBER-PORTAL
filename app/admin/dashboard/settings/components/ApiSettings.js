          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
            ...
            {formData.enableApi && (
              <>
                ...
                <div>
                  <label htmlFor="apiKeyExpiration" className="block text-sm font-medium text-gray-700 mb-1">
                    อายุของ API Key
                  </label>
                  <div className="flex items-center">
                    <input
                ...
                <div>
                  <label htmlFor="apiWhitelist" className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    เว้นว่างไว้เพื่ออนุญาตทุก IP หรือระบุ IP แต่ละรายการในแต่ละบรรทัด (รองรับ CIDR notation เช่น 192.168.1.0/24)
                  </p>
                </div>
              </>
            )}
