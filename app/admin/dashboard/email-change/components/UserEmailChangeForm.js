    ...
    <div className="space-y-6">
      ...
      {emailSent ? (
        <div className="bg-green-50 p-6 rounded-lg border border-green-200 text-center">
          ...
          <h3 className="text-lg font-medium text-green-800 mb-2">อีเมลยืนยันถูกส่งเรียบร้อยแล้ว</h3>
          <p className="text-green-600 mb-4">
            อีเมลยืนยันได้ถูกส่งไปยัง {formData.newEmail} เรียบร้อยแล้ว<br />
