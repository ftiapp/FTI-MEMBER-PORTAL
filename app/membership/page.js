            ...
            <div className="flex items-center md:flex-1">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-medium text-blue-900">เจ้าหน้าที่ตรวจสอบข้อมูล และรับใบแจ้งหนี้ผ่านอีเมล</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
            {membershipTypes.map((type) => (
              ...
              >
                ...
                <h4 className="text-xl font-bold mb-2 text-blue-900">
                  {type.name}
                </h4>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mt-8">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-blue-500 pl-4">
              <h4 className="font-semibold text-blue-900 text-lg">ฉันสามารถเปลี่ยนประเภทสมาชิกได้ตลอดเวลาหรือไม่?</h4>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h4 className="font-semibold text-blue-900 text-lg">สมาชิกแต่ละประเภทมีเงื่อนไขการสมัครต่างกันอย่างไร?</h4>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h4 className="font-semibold text-blue-900 text-lg">สิทธิประโยชน์ที่สำคัญที่สุดคืออะไร?</h4>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h4 className="font-semibold text-blue-900 text-lg">ฉันจะได้รับประโยชน์จากการเป็นสมาชิกอย่างไร?</h4>
