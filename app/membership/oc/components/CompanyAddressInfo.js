...
export default function CompanyAddressInfo({ formData, setFormData, errors, isAutofill }) {
  ...
  return (
    ...
    >
      ...
      <div className="bg-blue-600 px-8 py-6">
        <h3 className="text-xl font-semibold text-white tracking-tight">ที่อยู่บริษัท</h3>
      </div>
