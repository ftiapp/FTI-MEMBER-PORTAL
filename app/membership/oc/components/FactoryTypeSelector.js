        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg p-4 border border-blue-200">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p>• มีใบอนุญาตประกอบกิจการโรงงาน (รง.4) / ใบอนุญาตให้ใช้ที่ดินและประกอบกิจการในนิคมอุตสาหกรรม (กนอ.)</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 border border-blue-200">
            ...
            <p className="text-sm text-gray-700 mb-3">ไม่มีเครื่องจักร / มีเครื่องจักร ต่ำกว่า 5 แรงม้า</p>
            <div className="text-xs text-gray-600 space-y-1">
              <p>• ไม่มีใบอนุญาต พิจารณาจากเลขรหัสธุรกิจ (TSIC Code) ที่จดทะเบียนกับกรมพัฒนาธุรกิจการค้าที่แสดงถึงความเกี่ยวข้องกับอุตสาหกรรม โดยใช้หลักฐาน คือ</p>
        ...
        <div className="space-y-3">
          <label className="flex items-start gap-4 p-4 rounded-lg border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 cursor-pointer">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-600">
                ต้องมีใบอนุญาตประกอบกิจการโรงงาน (รง.4) หรือ ใบอนุญาตให้ใช้ที่ดินและประกอบกิจการในนิคมอุตสาหกรรม (กนอ.)
              </div>
            </div>
          </label>
          ...
          <label className="flex items-start gap-4 p-4 rounded-lg border-2 border-gray-200 hover:border-green-300 hover:bg-green-50 transition-all duration-200 cursor-pointer">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-700 mb-2">ไม่มีเครื่องจักร / มีเครื่องจักรต่ำกว่า 5 แรงม้า</div>
              <div className="text-xs text-gray-600">
