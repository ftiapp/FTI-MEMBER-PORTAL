              ...
              <div className="bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl p-6 border border-gray-200">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div className="text-sm text-gray-500 bg-white px-3 py-1 rounded-full border border-gray-200">
                    {(formData.industrialGroupId?.length || 0) + (formData.provincialChapterId?.length || 0)} รายการ
                  </div>
                </div>
                        ...
                        {formData.industrialGroupId.map(id => {
                          ...
                          return group ? (
                            ...
                            >
                              ...
                              <span className="text-sm font-medium">{group.MEMBER_GROUP_NAME || group.name_th}</span>
                      ...
                      <div className="flex flex-wrap gap-2.5">
                        {formData.provincialChapterId.map(id => {
                          const chapter = Array.isArray(provincialChapters) 
                            ...
                            : provincialChapters?.data?.find(c => c.id === id || c.MEMBER_GROUP_CODE === id);
                          return chapter ? (
                            <div
                              key={id}
                            ...
                            >
                              ...
                              <span className="text-sm font-medium">{chapter.name_th || chapter.MEMBER_GROUP_NAME}</span>
