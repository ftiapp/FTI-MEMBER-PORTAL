...
export default function SummarySectionComponent({
  ...
  const getContactPersonFullName = (isEnglish = false) => {
    ...
    if (formData.contactPersons && formData.contactPersons.length > 0) {
      ...
      if (isEnglish) {
        ...
        return (mainContact.firstNameEn || mainContact.firstNameEng) &&
          (mainContact.lastNameEn || mainContact.lastNameEng)
      ...
      return (mainContact.firstNameTh || mainContact.firstNameThai) &&
        (mainContact.lastNameTh || mainContact.lastNameThai)
    ...
    const prename =
      formData.contactPersonPrenameTh === "อื่นๆ" || formData.contactPersonPrenameTh === "อื่น ๆ"
        ? formData.contactPersonPrenameOther || ""
  ...
  const getContactPersonDetails = () => {
    ...
    return {
      ...
      phoneExtension:
        formData.contactPersonPhoneExtension ||
        formData.contact_person_phone_extension ||
      ...
      <Section title="ข้อมูลบริษัท">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <InfoCard
            ...
            value={
              formData?.companyNameEn || formData?.companyNameEng || formData?.company_name_eng
            }
          />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <InfoCard
                    ...
                    value={(function () {
                      ...
                      const ext = fields.phoneExtension;
                      if (p === "-") return "-";
        ...
        <Section title="ที่อยู่บริษัท" className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <InfoCard
              title="โทรศัพท์"
              value={(function () {
                const f = addressFields["2"];
                const p = f.phone;
                const ext = f.phoneExtension;
                if (p === "-") return "-";
                return ext ? `${p} ต่อ ${ext}` : p;
              })()}
            />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <InfoCard
                  title="เบอร์โทรศัพท์"
                  value={(function () {
                    const d = getContactPersonDetails();
                    const p = d.phone;
                    const ext = d.phoneExtension;
                    if (p === "-") return "-";
                    return ext ? `${p} ต่อ ${ext}` : p;
                  })()}
                />
                          ...
                          <div>
                            ...
                            {(() => {
                              const getPrenameTh = (c) => {
                                ...
                                if (pre && (pre === "อื่นๆ" || pre === "อื่น ๆ"))
                                  return c.prenameOther || "";
                                return pre;
                              };
                              const parts = [
            ...
            {formData.signatories.map((signatory, index) => (
              <div key={index} className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    <p className="text-xs text-gray-500">ตำแหน่ง</p>
                    <p className="text-sm">{signatory?.positionTh || "-"}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {(() => {
            const employeesValue =
              ...
              formData?.employees;
            return <InfoCard title="จำนวนพนักงาน" value={employeesValue} />;
          })()}
      ...
      <Section title="เอกสารที่จำเป็น" className="mt-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">เอกสารที่จำเป็นต้องอัพโหลด</h3>
              <div className="mt-2 text-sm text-red-700">
                <p>
                  เอกสารเหล่านี้จำเป็นสำหรับการสมัครสมาชิก กรุณาตรวจสอบให้แน่ใจว่าได้อัพโหลดครบถ้วน
                </p>
              </div>
            </div>
          </div>
