...
export default function MembershipCards() {
  ...
  const membershipTypes = [
    {
      id: "oc",
      name: "สามัญ-โรงงาน (สน)",
      description: "สำหรับผู้ประกอบการภาคอุตสาหกรรมโรงงาน",
      annual_fee: 1000,
    ...
    {
      id: "am",
      name: "สามัญ-สมาคมการค้า (สส)",
      description: "สำหรับสมาคมการค้าที่เกี่ยวข้องกับอุตสาหกรรม",
      annual_fee: 10000,
    ...
    {
      id: "ac",
      name: "สมทบ-นิติบุคคล (ทน)",
      description: "สำหรับนิติบุคคลที่ทำงานด้านอุตสาหกรรม",
      annual_fee: 2400,
    ...
    {
      id: "ic",
      name: "สมทบ-บุคคลธรรมดา (ทบ)",
      description: "สำหรับบุคคลธรรมดาที่สนใจงานด้านอุตสาหกรรม",
      annual_fee: 600,
      feeText: "600 บาท/ปี",
      features: [
        "เข้าร่วมกิจกรรมของสภาอุตสาหกรรม",
