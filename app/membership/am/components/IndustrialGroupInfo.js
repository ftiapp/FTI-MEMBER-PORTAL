...
export default function IndustrialGroupInfo({ formData, setFormData, errors }) {
  ...
  useEffect(() => {
    ...
    formData.industrialGroups,
    formData.provincialCouncils,
    formData.industrialGroupNames,
    formData.provincialChapterNames,
  ]);
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                ...
                เพื่อระบุกลุ่มอุตสาหกรรมและสภาอุตสาหกรรมจังหวัดที่สมาคมมีส่วนเกี่ยวข้อง
              </p>
            </div>
          </div>
        </div>
