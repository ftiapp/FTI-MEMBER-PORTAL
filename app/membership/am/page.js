...
import OCStepIndicator from '../oc/components/OCStepIndicator'; // ใช้ OCStepIndicator เดิม
import { Toaster } from 'react-hot-toast';

export default function AMMembership() {
        ...
        <div className="relative bg-gradient-to-r from-blue-900 to-blue-700 text-white py-16 md:py-24">
          ...
          <div className="container mx-auto px-4 relative z-10 max-w-5xl">
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-center">
              สมัครสมาชิกประเภท สามัญ-สมาคมการค้า (สส)
            </h1>
            <motion.div 
            ...
            <p className="text-lg md:text-l text-center max-w-3xl mx-auto">
             สมาคมการค้าที่ตั้งขึ้นตามกฎหมายว่าด้วย สมาคมการค้า และมีวัตถุประสงค์เพื่อส่งเสริมการประกอบอุตสาหกรรม
            </p>
          </div>
        </div>
