...
import AMStepIndicator from "@/app/membership/am/components/AMStepIndicator";
        ...
        <div className="relative bg-gradient-to-r from-blue-900 to-blue-700 text-white py-16 md:py-24">
          ...
          <div className="container mx-auto px-4 relative z-10 max-w-5xl">
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-center">
              แก้ไขใบสมัครสามัญ-สมาคมการค้า (AM) จากข้อมูลระบบหลัก
            </h1>
            <motion.div
            ...
            <p className="text-lg md:text-xl text-center text-blue-100 max-w-3xl mx-auto">
              แบบฟอร์มหลายขั้นตอน พร้อมข้อมูลพื้นฐานที่ดึงจากตาราง MemberRegist_AM_Main (ID: {params.id})
            </p>
          </div>
        </div>
