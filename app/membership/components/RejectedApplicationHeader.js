...
export default function RejectedApplicationHeader({ 
  rejectedApp, 
  membershipTypeLabel 
}) {
          ...
          <div className="space-y-2">
            ...
            {rejectedApp.applicationName && (
              <div>
                ...
                <span className="text-sm font-medium text-gray-900">{rejectedApp.applicationName}</span>
              </div>
            )}
            ...
            {rejectedApp.resubmissionCount > 0 && (
              <div>
                ...
                <span className="text-sm font-medium text-orange-600">{rejectedApp.resubmissionCount} ครั้ง</span>
              </div>
            )}
          </div>
        </div>
