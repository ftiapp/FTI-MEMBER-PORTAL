...
const BusinessTypesField = forwardRef(
  ({ formData, setFormData, errors, businessTypes, otherFieldRef }, ref) => {
      ...
      <div ref={ref} className="bg-white border border-gray-200 rounded-lg p-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">
            เลือกประเภทธุรกิจที่เกี่ยวข้อง (เลือกได้มากกว่า 1 ข้อ) / Select related business types
        ...
        {formData.businessTypes?.other && (
          <div ref={otherFieldRef} className="mt-6 pt-6 border-t border-gray-100">
            ...
            >
              โปรดระบุประเภทธุรกิจอื่นๆ / Please specify other business type
