...
// AC components
import ACCompanyInfoSection from "../../ac/components/CompanyInfoSection";
import ACBusinessInfoSection from "../../ac/components/BusinessInfoSection";
import ACDocumentUploadSection from "../../ac/components/DocumentUploadSection";
// AM components
import AMAssociationInfoSection from "../../am/components/AssociationInfoSection";
import AMBusinessInfoSection from "../../am/components/BusinessInfoSection";
import AMDocumentUploadSection from "../../am/components/DocumentUploadSection";
      ...
      case "am":
        return (
          <div className="space-y-8">
            ...
            >
              <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mb-4">
                <h3 className="text-lg font-semibold text-blue-900">1. ข้อมูลสมาคม</h3>
              </div>
              <AMAssociationInfoSection
                formData={formData}
                setFormData={setFormData}
                errors={errors}
                setErrors={setErrors}
