        ...
        {(address.ADDR_TELEPHONE) && (
          <div className="flex items-start bg-white p-4 rounded-lg border border-gray-100 hover:shadow-md transition-all">
            <div className="flex items-center mb-2">
              ...
              <div>
                <p className="font-semibold text-blue-700 mb-2">{isThai ? 'โทรศัพท์' : 'Telephone'}</p>
            ...
            <div className="overflow-hidden">
              ...
              <a 
                href={(() => {
                  ...
                  const website = isThai ? address.ADDR_WEBSITE : (address.ADDR_WEBSITE_EN || address.ADDR_WEBSITE);
