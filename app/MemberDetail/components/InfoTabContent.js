...
import { 
  FaBuilding, FaIdCard, FaUsers, FaUser, FaCheckCircle, 
  FaTimesCircle, FaExclamationCircle, FaInfoCircle, FaIndustry, FaCity 
} from 'react-icons/fa';
...
export default function InfoTabContent({ 
  companyInfo, memberTypeInfo, statusInfo, 
  getOrganizationType, containerVariants, itemVariants, 
  multipleCompanies 
}) {
  return (
    <motion.div 
    ...
    >
      ...
      >
        <motion.div className="space-y-5" variants={itemVariants}>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 font-semibold">{getOrganizationType(companyInfo.MEMBER_MAIN_GROUP_CODE)}</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-700">
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-${memberTypeInfo.color}-100 text-${memberTypeInfo.color}-800`}>
                {memberTypeInfo.name}
              </span>
            </p>
          </div>
        ...
        >
          ...
          {(statusInfo.color === 'yellow' || statusInfo.color === 'orange') && <FaExclamationCircle className="mt-1 mr-3 text-yellow-500" />}
          {(statusInfo.color === 'blue' || statusInfo.color === 'purple' || statusInfo.color === 'gray') && <FaInfoCircle className="mt-1 mr-3 text-blue-500" />}
          <div>
        ...
        {companyInfo.MEMBER_MAIN_GROUP_CODE === '100' && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 font-semibold">{companyInfo.Industry_GROUP_NAME || '-'}</p>
            </div>
          </motion.div>
        )}
        ...
        {companyInfo.MEMBER_MAIN_GROUP_CODE === '200' && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 font-semibold">{companyInfo.Province_GROUP_NAME || '-'}</p>
            </div>
          </motion.div>
        )}
