...
import { 
  FaBuilding, FaIndustry, FaCity, FaIdCard, FaUsers 
} from 'react-icons/fa';
    ...
    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {Object.entries(membershipTypes['000']).map(([groupCode, groupInfo]) => (
                ...
                >
                  ...
                  <div>
                    <p className="font-medium text-blue-900">รหัสสมาชิก: {companyInfo.MEMBER_CODE}</p>
      ...
      >
        <p className="text-blue-700">
          <strong>หมายเหตุ:</strong> สมาชิกสามารถเป็นสมาชิกได้หลายประเภท เช่น เป็นทั้งสมาชิกสภาอุตสาหกรรมแห่งประเทศไทย และสมาชิกกลุ่มอุตสาหกรรม
        </p>
      </motion.div>
    </motion.div>
  );
