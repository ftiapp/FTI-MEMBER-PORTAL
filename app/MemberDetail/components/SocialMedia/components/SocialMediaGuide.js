        ...
        {isOpen && (
          ...
          >
            <div className="mt-4 text-sm text-blue-800 space-y-3">
              <p>การเพิ่มช่องทางโซเชียลมีเดียจะช่วยให้ผู้ที่สนใจสามารถติดตามข่าวสารและติดต่อกับบริษัทของคุณได้ง่ายขึ้น</p>
              ...
              <div className="space-y-2">
                ...
                <ul className="list-disc list-inside pl-4 space-y-1">
                  <li><span className="font-medium">พื้นฐาน:</span> Facebook Page, Line Official Account, YouTube Channel, Website/Homepage</li>
                  <li><span className="font-medium">เพิ่มเติม:</span> Instagram, TikTok, Twitter/X, LinkedIn (สำหรับ B2B), Shopee/Lazada (ถ้าขายของออนไลน์)</li>
                </ul>
              </div>
              
              <p className="italic">หมายเหตุ: ข้อมูลโซเชียลมีเดียที่เพิ่มจะแสดงในหน้าโปรไฟล์บริษัทของคุณ</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
