...
export const CookieManager = {
  ...
  savePreferences: (settings, consentType = "custom") => {
    try {
      ...
      Cookies.set("cookieConsentDate", consentDate, {
        expires: 365,
        sameSite: "strict",
        path: "/",
      });
  ...
  getPreferences: () => {
    ...
    try {
      ...
      if (localStorageValue) {
        ...
        Cookies.set("cookiePreferences", localStorageValue, {
          expires: 365,
          sameSite: "strict",
          path: "/",
        });
  ...
  hasConsent: () => {
    ...
    try {
      ...
      if (localStorageConsent) {
        // บันทึกกลับลงใน cookie ด้วย
        Cookies.set("cookieConsent", localStorageConsent, {
          expires: 365,
          sameSite: "strict",
          path: "/",
        });
