...
export default function VerifyOTP({ userId, onSuccess, onBack, title, description, isNewEmail = false }) {
  ...
  return (
    <div className="bg-white rounded-lg max-w-md mx-auto">
      <div className="text-center mb-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">{title || 'ขั้นตอนที่ 2: ยืนยันรหัส OTP'}</h2>
