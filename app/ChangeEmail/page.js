                    ...
                    <>
                      <div className="mb-2">
                        <div className="flex items-center">
                          ...
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 4 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
                            4
                          </div>
                          <div className={`flex-1 h-1 mx-2 ${currentStep >= 5 ? 'bg-blue-600' : 'bg-gray-200'}`}></div>
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 5 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
                            5
                          </div>
                        </div>
                      </div>
