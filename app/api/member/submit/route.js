  ...
  try {
    ...
    if (existingMemberOtherUser.length > 0) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: "รหัสสมาชิกนี้ถูกใช้งานโดยผู้ใช้อื่นแล้ว ไม่สามารถใช้ยืนยันตัวตนได้",
        },
        { status: 400 },
      );
    }
    ...
    if (existingMemberSameUser.length > 0) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: "คุณได้ยืนยันตัวตนด้วยรหัสสมาชิกนี้ไปแล้ว กรุณาใช้รหัสสมาชิกอื่น",
        },
        { status: 400 },
      );
    }
    ...
    if (fileSizeMB > 5) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: `ไฟล์มีขนาดใหญ่เกินไป (${fileSizeMB.toFixed(2)}MB) กรุณาอัปโหลดไฟล์ขนาดไม่เกิน 5MB`,
        },
        { status: 400 },
      );
    }
    ...
    return NextResponse.json({
      ...
      memberCode: trimmedMemberNumber,
