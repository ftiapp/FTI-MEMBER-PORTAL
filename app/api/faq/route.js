...
const THAI_LANGUAGE_UTILS = {
  ...
  stopwords: [
    'ที่', 'และ', 'ใน', 'ของ', 'ให้', 'ได้', 'ไป', 'มา', 'กับ', 'จะ', 'ไม่', 'เป็น', 'มี',
    'ว่า', 'การ', 'ค่ะ', 'คะ', 'ครับ', 'นะ', 'ค่ะ', 'ขอ', 'อยาก', 'ต้องการ', 'อยากทราบ', 'รบกวน',
    'หรือ', 'แล้ว', 'ก็', 'คือ', 'เพื่อ', 'เมื่อ', 'ถ้า', 'หาก', 'แต่', 'อีก', 'นั้น', 'นี้',
    'ซึ่ง', 'ตัว', 'อัน', 'แห่ง', 'ช่วย', 'บอก', 'ทำ', 'ไร', 'อะไร', 'ยัง', 'เลย', 'แค่', 'เพียง'
  ],
...
export async function POST(request) {
  try {
    ...
    if (isGreeting || question.trim().length <= 10 && 
