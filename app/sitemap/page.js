    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-blue-900 to-blue-700 text-white py-16 md:py-24">
        ...
        {!isMobile && (
          <div className="absolute right-10 top-1/2 transform -translate-y-1/2 hidden lg:block opacity-15">
            ...
            >
              ...
              />
              <path
                d="M13 19V17C13 16.4696 13.2107 15.9609 13.5858 15.5858C13.9609 15.2107 14.4696 15 15 15H19C19.5304 15 20.0391 15.2107 20.4142 15.5858C20.7893 15.9609 21 16.4696 21 17V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H15C14.4696 21 13.9609 20.7893 13.5858 20.4142C13.2107 20.0391 13 19.5304 13 19Z"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-5xl">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 text-center">แผนผังเว็บไซต์</h1>
          <motion.div
      ...
      <main className="flex-grow container mx-auto px-4 py-12 max-w-7xl">
        ...
        >
          <h3 className="text-xl font-bold text-blue-800 mb-4">ข้อมูลเพิ่มเติม</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700">
            <div>
              <h4 className="font-semibold mb-2">การนำทาง</h4>
              <p className="text-sm">
                เว็บไซต์ของเราออกแบบมาให้ใช้งานง่าย สามารถเข้าถึงข้อมูลและบริการต่างๆ
            ...
            <div>
              ...
              <p className="text-sm">
                หากท่านมีข้อสงสัยหรือต้องการความช่วยเหลือ สามารถติดต่อเราผ่านหน้า{" "}
