          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">4. การรักษาความปลอดภัยของข้อมูล</h3>
                  <p className="mb-4">
                    เราได้นำมาตรการรักษาความปลอดภัยที่เหมาะสมเพื่อปกป้องข้อมูลส่วนบุคคลของท่าน ซึ่งรวมถึง:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">5. สิทธิของเจ้าของข้อมูล</h3>
                  <p className="mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">6. การใช้คุกกี้ (Cookies)</h3>
                  <p className="mb-4">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    ท่านสามารถปรับการตั้งค่าเบราว์เซอร์เพื่อปฏิเสธการใช้คุกกี้ได้ แต่อาจส่งผลให้บางฟังก์ชันของเว็บไซต์ทำงานไม่ปกติ
                  </p>
                </div>
