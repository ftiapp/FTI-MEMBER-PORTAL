-- Add name columns to AC membership tables
...
-- Add name column to MemberRegist_AC_IndustryGroups table
ALTER TABLE MemberRegist_AC_IndustryGroups 
ADD COLUMN industry_group_name VARCHAR(255) NULL AFTER industry_group_id;

-- Add name column to MemberRegist_AC_ProvinceChapters table
ALTER TABLE MemberRegist_AC_ProvinceChapters 
...
CREATE INDEX idx_ac_industry_groups_name ON MemberRegist_AC_IndustryGroups(industry_group_name);
CREATE INDEX idx_ac_province_chapters_name ON MemberRegist_AC_ProvinceChapters(province_chapter_name);
