-- Add name columns to OC membership tables
...
-- Add name column to MemberRegist_OC_IndustryGroups table
ALTER TABLE MemberRegist_OC_IndustryGroups 
ADD COLUMN industry_group_name VARCHAR(255) NULL AFTER industry_group_id;

-- Add name column to MemberRegist_OC_ProvinceChapters table
ALTER TABLE MemberRegist_OC_ProvinceChapters 
...
CREATE INDEX idx_oc_industry_groups_name ON MemberRegist_OC_IndustryGroups(industry_group_name);
CREATE INDEX idx_oc_province_chapters_name ON MemberRegist_OC_ProvinceChapters(province_chapter_name);
