-- Add name columns to AM membership tables
...
-- Add name column to MemberRegist_AM_IndustryGroups table
ALTER TABLE MemberRegist_AM_IndustryGroups 
ADD COLUMN industry_group_name VARCHAR(255) NULL AFTER industry_group_id;

-- Add name column to MemberRegist_AM_ProvinceChapters table
ALTER TABLE MemberRegist_AM_ProvinceChapters 
...
CREATE INDEX idx_am_industry_groups_name ON MemberRegist_AM_IndustryGroups(industry_group_name);
CREATE INDEX idx_am_province_chapters_name ON MemberRegist_AM_ProvinceChapters(province_chapter_name);
